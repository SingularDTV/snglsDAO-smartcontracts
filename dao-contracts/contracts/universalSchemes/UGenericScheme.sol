    ...
    ProposalExecuteInterface
{
        ...
        returns (bool)
    {
        ...
        CallProposal storage proposal = organizationsProposals[address(
            avatar
        )][_proposalId];
        ...
        emit ProposalExecutedByVotingMachine(
            address(avatar),
            _proposalId,
            _decision
        );
    ...
    function execute(Avatar _avatar, bytes32 _proposalId) public {
        Parameters memory params = parameters[getParametersFromController(
            _avatar
        )];
        CallProposal storage proposal = organizationsProposals[address(
            _avatar
    ...
    function getParametersHash(
        ...
        return
            keccak256(abi.encodePacked(_voteParams, _intVote, _contractToCall));
    }
}
