...
class CreateProposal extends React.Component<IProps, IStateProps> {
  ...
  public handleSubmit = async (values: IFormValues, { _setSubmitting }: any ): Promise<void> => {
    ...
    const reputationContract = new arc.web3.eth.Contract(reputationContractAbi, "0x9E0384B3f5944C1C7F6b00CB66c705ad0029051e");
    ...
    const tokenContract = new arc.web3.eth.Contract(erc20TokenContractAbi, '0x1091232Bf36aa521611bb877cCC652EA42ae9dEf');

    // Instantiate contract    
    const toAddress = '0x9E0384B3f5944C1C7F6b00CB66c705ad0029051e';
