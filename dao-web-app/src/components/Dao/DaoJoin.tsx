...
class CreateProposal extends React.Component<IProps, IStateProps> {
  ...
  public handleSubmit = async (values: IFormValues, { _setSubmitting }: any ): Promise<void> => {
    ...
    const reputationContract = new arc.web3.eth.Contract(reputationContractAbi, "0x1b13812c665b6D258f7c4143D6a8c729B21D9AAC");
    ...
    const tokenContract = new arc.web3.eth.Contract(erc20TokenContractAbi, '0xC0459a7fb2dbeCCc31BAA4e7755163884628F942');

    // Instantiate contract    
    const toAddress = '0x1b13812c665b6D258f7c4143D6a8c729B21D9AAC';
...
const SubscribedCreateContributionRewardExProposal = withSubscription({
  ...
  createObservable: (props: IExternalProps) => {
    const arc = getArc();
    return arc.dao("0x6C3903C0d77E5F03F27793Eb40E5F67B9B4503b2").state();
  },
});
