...
class CreateProposal extends React.Component<IProps, IStateProps> {
  ...
  public handleSubmit = async (values: IFormValues, { _setSubmitting }: any ): Promise<void> => {
    ...
    const reputationContract = new arc.web3.eth.Contract(reputationContractAbi, "0xBBefA158327a439147478e55458C7cd81037c991");
    ...
    const tokenContract = new arc.web3.eth.Contract(erc20TokenContractAbi, '0x099D21625D7d5Ed248E6c49621ACD12f97267828');

    // Instantiate contract    
    const toAddress = '0xBBefA158327a439147478e55458C7cd81037c991';
