...
class CreateProposal extends React.Component<IProps, IStateProps> {
  ...
  public handleSubmit = async (values: IFormValues, { _setSubmitting }: any ): Promise<void> => {
    ...
    const reputationContract = new arc.web3.eth.Contract(reputationContractAbi, "0x056cEec53F606044F2ee53Fdb27aE01784C114f8");
    ...
    const tokenContract = new arc.web3.eth.Contract(erc20TokenContractAbi, '0xbB3a87aD9b28cfa4015B33Fb7e08879352F78e4b');

    // Instantiate contract    
    const toAddress = '0x056cEec53F606044F2ee53Fdb27aE01784C114f8';
...
const SubscribedCreateContributionRewardExProposal = withSubscription({
  ...
  createObservable: (props: IExternalProps) => {
    const arc = getArc();
    return arc.dao("0x2F250C487F5213659E8BD29DfB4B9f4c6FA079A7").state();
  },
});
