          ...
          <div className={css.topInfo}>
            ...
            <div className={navigationClass}>
              <ul>
                ...
                <li className={css.submenu}><span>{t('header.resources.resources')}</span>
                  <ul>
                    <li><a href="https://twitter.com/SNGLSDAO" target="_blank">{t('header.resources.twitter')}</a></li>
                    <li><a href="https://medium.com/singulardtv" target="_blank">{t('header.resources.medium')}</a></li>
                    <li><a href="https://weibo.com/snglsdao" target="_blank">{t('header.resources.weibo')}</a></li>
                  </ul>
                </li>
                ...
                <li className={css.redSelector}><a className={css.menu__link} href="https://app.snglsdao.io/">{t("header.dao")}</a></li>
