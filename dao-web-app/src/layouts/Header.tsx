        ...
        <nav id="header" className={css.header}>
          ...
          <div className={css.topInfo}>
            ...
            <div className={navigationClass}>
              <ul>
                <li><a href="https://snglsdao.io/">DAO</a></li>
                <li><a href="https://forum.snglsdao.io/" target="_blank">Forum</a></li>
                <li className={css.submenu}><span>Consumer Protection</span>
                    <ul>
                      <li><a href="https://github.com/SingularDTV/snglsdao-whitepaper" target="_blank">Token Economics</a></li>
                      <li><a href="https://snglsdao.io/#roadmap" target="_blank">Roadmap</a></li>
                      <li className={css.submenu}><span>Source Code</span>
                        <ul>
                          <li><a href="https://etherscan.io/address/0xaec2e87e0a235266d9c5adc9deb4b2e29b54d009#code" target="_blank">SNGLS</a></li>
                          <li><a href="https://snglsdao.io/" target="_blank">SGT</a></li>
                          <li><a href="https://github.com/SingularDTV/snglsDAO-smartcontracts" target="_blank">snglsDAO</a></li>
                        </ul>
                      </li>
                      <li className={css.submenu}><span>Transaction History</span>
                        <ul>
                          <li><a href="https://etherscan.io/token/0xaec2e87e0a235266d9c5adc9deb4b2e29b54d009" target="_blank">SNGLS</a></li>
                          <li><a href="https://snglsdao.io/" target="_blank">SGT</a></li>
                        </ul>
                      </li>
                      <li className={css.submenu}><span>History of Past Token Sales</span>
                        <ul>
                          <li><a href="https://etherscan.io/address/0xbdf5c4f1c1a9d7335a6a68d9aa011d5f40cf5520" target="_blank">SNGLS</a></li>
                          <li><a href="https://snglsdao.io/" target="_blank">SGT</a></li>
                        </ul>
                      </li>
                      <li className={css.submenu}><span>Token Holders</span>
                        <ul>
                          <li><a href="https://etherscan.io/token/0xaec2e87e0a235266d9c5adc9deb4b2e29b54d009#balances" target="_blank">SNGLS</a></li>
                          <li><a href="https://snglsdao.io/" target="_blank">SGT</a></li>
                        </ul>
                      </li>
                      <li className={css.submenu}><span>Security Audit</span>
                        <ul>
                          <li><a href="https://snglsdao.io/" target="_blank">snglsDAO</a></li>
                        </ul>
                      </li>
                    </ul>
                </li>
                <li className={css.submenu}><span>News</span>
                  <ul>
                    <li><a href="https://twitter.com/SNGLSDAO" target="_blank">Twitter</a></li>
                    <li><a href="https://medium.com/singulardtv" target="_blank">Medium</a></li>
                    <li><a href="https://weibo.com/snglsdao" target="_blank">WeiBo</a></li>
                  </ul>
                </li>
                <li><a href="https://snglsdao.io/#contacts">Subscribe</a></li>
