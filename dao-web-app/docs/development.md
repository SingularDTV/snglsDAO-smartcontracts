...
# Developing @daostack/clientc in tandem with alchemy with npm link
...
npm link @daostack/clientc
```
Now you should find a link to your local `client` directory in `node_modules/@daostack/clientc`

## The development cycle

The alchemy webpack process uses the compiled `.js` files in `@daostack/clientc/dist`.
